...
RSpec.describe "graduates/new", type: :view do
  before(:each) do
    assign(:graduate, Graduate.new(
      :first_name => "MyString",
      :last_name => "MyString",
      :email => "MyString",
      :phone => "MyString",
  ...
  it "renders new graduate form" do
    render

    assert_select "form[action=?][method=?]", graduates_path, "post" do
